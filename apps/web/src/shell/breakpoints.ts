 ...
 * at or below COMPACT_LAYOUT side-by-side layouts stack and secondary
 * topbar content hides. shell.css mirrors these values in its media
 * queries — keep them in sync.
 */

/** Widest viewport (px) where the nav rail defaults to collapsed. */
export const BREAKPOINT_COMPACT_NAV = 1279;

/** Widest viewport (px) where side-by-side layouts stack. */
