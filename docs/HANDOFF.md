...
- **Progress (updated as epics complete):** FND (12), DB (5), TEN (12), DSN (9), JOB (8), CFG (14), STO (6), ING (14), PRC (14), REV (16), and CAN (4) are DONE — implemented, tested, committed to `dev`, CI green. (REV-016's study protocol is written — `docs/REVIEW_USABILITY_BENCHMARK.md` — but the human study itself runs during PIL; its release gate stays open until then.) Next action: `EXP-001` in `docs/BUILD_BACKLOG.md`, then the rest of EXP in order.
